...
export function DataTableKategori( { onCreate, onEdit, onDelete }: { onCreate: () => void; onEdit: (category: z.infer<typeof categorySchema>) => void; onDelete: (category: z.infer<typeof categorySchema>) => void; } ) {
    ...
    <div className="w-full">
      <div className="flex items-center justify-between pb-4">
        <Input
          ...
          className="max-w-sm"
        />
        <Button className="cursor-pointer" onClick={onCreate}>Buat Kategori
