...
import { usePurchaseReport } from "@/hooks/use-report";
...
export const DataTablePurchaseReport = React.memo( React.forwardRef<{getExportData: () => {headers: string[]; rows: (string|number)[][]}},
  {startDate: Date | undefined, endDate: Date | undefined}
> (({startDate, endDate},ref) => {
  const {data, isPending} = usePurchaseReport(startDate, endDate)
  const [sorting, setSorting] = React.useState<SortingState>([]);
  const columns: ColumnDef<PurchaseReport>[] = [
    {
      id: "no",
      header: "No",
    ...
    ,
    {
        ...
        cell: ({ row }) => <div>{row.getValue("namaSupplier")}</div>,   
    },
    {
